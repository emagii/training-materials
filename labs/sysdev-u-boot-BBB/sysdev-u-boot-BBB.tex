...
Modify the \code{$HOME} variable to your own HOME directory.

For technical reasons, long lines are split up in this pdf file, 
using the {\bf \code{'\'}} character.
In the \code{uEnv.txt} file, they must be a single line with the {\bf \code{'\'}} character removed.
...
For technical reasons, long lines are split up in this pdf file, 
using the {\bf \code{'\'}} character.
In the \code{uSetup.txt} file, they must be a single line with the {\bf \code{'\'}} character removed.
...
This should show {\bf Your} HOME directory, and not \code{/home/ulf}
